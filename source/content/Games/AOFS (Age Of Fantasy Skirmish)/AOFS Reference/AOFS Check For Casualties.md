...
| ------ | --------------------------------------------------------------------------- |
| 1      | **Dead** - Remove the unit from your warband sheet (losing all its points). |
...
| Result | Hero Units                                                                              |
| ------ | --------------------------------------------------------------------------------------- |
| 1      | **Injury Trait** - Hero recovers, becomes 5 pts cheaper and get an Injury trait.        |
| 2-5    | **Recovered** - Hero recovers and may be used without penalties.                        |
| 6      | **Talent Trait** - Hero recovers, becomes 5 pts more expensive and gets a Talent trait. |

| Result | Injury Trait                                                                 |
| ------ | ---------------------------------------------------------------------------- |
| 1      | **Dead** - Remove the hero from your warband sheet. (losing all its points). |
